...
/** Mirrors backend/sales/models.py's QuoteLineItem — see
 * docs/API_CONTRACT.md's "quote_line_item" field payload. line_total is
 * server-derived (see Sync::push_post(), which computes it inline from
 * quantity/unit_price before insert/update, and Quote_model::recompute_totals()
 * which sums these into the parent quote). */
class Quote_line_item_model extends Business_owned_model {
